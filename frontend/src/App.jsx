		...
		return (
			...
			<table className="text-lg md:text-4xl font-serif text-gray-500 m-2">
				<tbody>
					{hours.map((row, index) => (
						<tr key={index}>
							<td className="text-left py-2 pr-3 sm:pr-20 md:pr-30">{row.day.toProperCase()}</td>
		  	...
		  	<table className="text-xl md:text-3xl text-gray-800 font-serif m-2 md:m-5">
		  		<tbody>
		  			...
		  			<tr>
		  				...
		  				<td className="text-left pb-3"><a href='mailto:orders@prontocafegelato.com'>orders@prontocafegelato.com</a></td>
		  			</tr>
		  			<tr>
